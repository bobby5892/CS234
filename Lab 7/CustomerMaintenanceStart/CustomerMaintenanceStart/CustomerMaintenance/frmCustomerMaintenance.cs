    ...
    public partial class frmCustomerMaintenance : Form
    {
        ...
        private void GetCustomer(int CustomerID)
        {
            try
            {
                ...
                selectedCustomer = MMABooksEntities.entities.Customers.Where(c => c.CustomerID == CustomerID).SingleOrDefault();
                ...
                else
                {
                    ...
                    if (!MMABooksEntities.entities.Entry(selectedCustomer).Reference("State1").IsLoaded)
                        MMABooksEntities.entities.Entry(selectedCustomer).Reference("State1").Load();
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            if (result == DialogResult.Yes)
            {
                try
                {
                    ...
                    MMABooksEntities.entities.Customers.Remove(selectedCustomer);
